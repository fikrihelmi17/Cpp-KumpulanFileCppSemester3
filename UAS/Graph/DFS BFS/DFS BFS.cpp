...
{ 
	...
	{ 
		...
		printf("\n1.B.F.S"); 
		printf("\n2.D.F.S"); 
		printf("\nENTER YOUR CHOICE"); //pemilihan menu
		scanf("%d",&ch); 
		printf("ENTER THE SOURCE VERTEX :"); 
		scanf("%d",&s); 
		
		//switch case menu bfs
		switch(ch) 
		{ 
			case 1:bfs(s,vertex); break; //diarahkan ke fungsi bfs
			case 2: dfs(s,vertex); break; //diarahkan ke fungsi dfs
		} 
